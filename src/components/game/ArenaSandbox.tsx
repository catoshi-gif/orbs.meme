  ...
  useEffect(()=>{
    ...
    (async()=>{
      ...
      function addPedestal(x:number,z:number,kind:ArenaPowerKind){
        ...
        const badge=makeLabel(THREE,kind==="superjump"?"↑ DOUBLE JUMP":kind==="blaster"?"● BLASTER":"» SUPER SPEED",accent);badge.position.set(x,5.15,z);badge.scale.multiplyScalar(.82);scene.add(badge);
