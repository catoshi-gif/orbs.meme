...
export default function AdminDashboard(){
  ...
  const cards=[
    ...
    ["Live players",T.totalLiveRacers],["Avg players / Orb",Number(T.averageRacersPerFundedOrb||0).toFixed(2)],["Registration rate",pct(T.waitingToRegistrationRate as number|null)],
