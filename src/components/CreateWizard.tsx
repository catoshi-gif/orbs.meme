    ...
    <div className="wizard-layout">
      ...
      <section className="wizard">
        ...
        {step === 1 ? <>
          ...
          <p>Pick SOL or standard SPL tokens already in your connected wallet. The winner receives the full advertised prize; the {money(ORBS_FEE_USD)} Orbs fee is added separately in the same token. Minimum launch commitment is {money(MIN_WALLET_REQUIREMENT_USD)} total: {money(MIN_PRIZE_USD)} prize + {money(ORBS_FEE_USD)} fee.</p>
