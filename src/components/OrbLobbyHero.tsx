...
import OrbCinematic from "@/components/OrbCinematic";
...
export default function OrbLobbyHero({ orb, winner = false }: { orb: PublicOrbRecord; winner?: boolean }) {
  ...
  const urgency = remaining <= 60_000 ? "final" : remaining <= 10 * 60_000 ? "warm" : "calm";

  return <section className="card prize-hero real-orb-hero">
    <div className="lobby-cinematic-bg"><OrbCinematic style={orb.style} variant="ambient" urgency={urgency}/></div>
