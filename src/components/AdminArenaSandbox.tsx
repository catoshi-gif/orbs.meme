...
export default function AdminArenaSandbox(){
  ...
  return <section className="admin-game-sandbox admin-arena-sandbox">
    <div className="admin-sandbox-heading">
      <div><span className="eyebrow">Multiplayer laboratory</span><h2>Arena game generator</h2><p>Local-only Arena with computer opponents. Tune population, world palette, pacing and capture format here while testing the focused power-ring system, recovery rings, pedestal jumps and vertical combat before Arena is exposed to creators.</p></div>
