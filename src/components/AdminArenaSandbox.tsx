...
export default function AdminArenaSandbox(){
  ...
  return <section className="admin-game-sandbox admin-arena-sandbox">
    <div className="admin-sandbox-heading">
      <div><span className="eyebrow">Multiplayer laboratory</span><h2>Arena game generator</h2><p>Local-only mirror of the live Arena rules with computer opponents. Tune population, palette and capture format here without touching prize state; ring-outs, column zaps, ramp spikes, three-dot Blaster volleys, Cloak, Skull Bombs, powers and recovery match the production game.</p></div>
