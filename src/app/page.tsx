...
export default async function Home() {
  ...
  return <>
    ...
    <section className="section open-source-section"><div className="container"><div className="open-source-card"><div className="open-source-copy"><span className="eyebrow">Open source · MIT</span><h2>See how Orbs works.</h2><p>The full codebase, from the Solana program and deterministic verification to the realtime MAZE, ARENA and RACE games are open for anyone to inspect, fork, and build on.</p></div><a className="btn-secondary open-source-link" href="https://github.com/catoshi-gif/orbs.meme" target="_blank" rel="noopener noreferrer" aria-label="View the Orbs.meme source code on GitHub"><svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M12 .7a11.3 11.3 0 0 0-3.57 22.02c.57.1.78-.25.78-.55v-2.16c-3.18.69-3.85-1.35-3.85-1.35-.52-1.32-1.27-1.67-1.27-1.67-1.04-.71.08-.7.08-.7 1.15.08 1.76 1.18 1.76 1.18 1.02 1.75 2.68 1.25 3.33.95.1-.74.4-1.25.73-1.54-2.54-.29-5.21-1.27-5.21-5.59 0-1.24.44-2.25 1.18-3.04-.12-.29-.51-1.46.11-3 0 0 .96-.31 3.11 1.16A10.8 10.8 0 0 1 12 6.03c.96 0 1.92.13 2.83.38 2.15-1.47 3.11-1.16 3.11-1.16.62 1.54.23 2.71.11 3 .74.79 1.18 1.8 1.18 3.04 0 4.33-2.68 5.29-5.23 5.58.41.36.78 1.06.78 2.14v3.16c0 .3.21.66.79.55A11.3 11.3 0 0 0 12 .7Z"/></svg><span>View source on GitHub</span><strong aria-hidden="true">↗</strong></a></div></div></section>
