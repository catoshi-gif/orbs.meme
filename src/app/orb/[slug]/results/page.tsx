...
export default async function Page({params}:{params:Promise<{slug:string}>}) {
  ...
  return <div className="page"><div className="container"><div className="result">
    ...
    {orb && winner?.wallet && !expired ? <ClaimPrizeButton slug={slug} winnerWallet={winner.wallet} hostWallet={orb.hostWallet} mint={orb.token.mint} orbId={orb.id} claimed={claimed} /> : null}
