...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <div className="page"><div className="container"><div className="lobby"><OrbLobbyHero orb={orb}/><OrbQualification slug={slug} hostXId={orb.hostX.id} hostUsername={orb.hostX.username} startsAt={orb.startsAt}/></div></div></div>;
}
