...
export default async function LeaderboardPage() {
  ...
  return <div className="page"><div className="container leaderboard-page">
    ...
    <h1 className="page-title">The fastest cats keep receipts.</h1>
    <p className="page-intro">Top X accounts by server-verified first-place Orb finishes. Wallet addresses stay out of the public leaderboard.</p>
    ...
    <p className="leaderboard-note">Only verified first-finisher records count. No wallet address is needed to rank publicly.</p>
  </div></div>;
}
