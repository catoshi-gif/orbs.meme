      ...
      <div className="container">
        ...
        <section className="gameplay-guide">
          <div className="gameplay-guide-heading">
            ...
            <h2>Two games. Two tiny practice floors.</h2>
            <p>Open the guide on the device you plan to play with. Each guide automatically presents the right control model and includes a lightweight browser-only practice game—no wallet, database, or live game server required.</p>
          </div>
        ...
        <section className="gameplay-guide how-trust-guide">
          <div className="gameplay-guide-heading">
            ...
            <p>The host funds the prize before launch. Players do not stake tokens against one another. MAZE verifies the first legitimate finish; ARENA uses the authoritative multiplayer server to determine the legitimate winner.</p>
          </div>
