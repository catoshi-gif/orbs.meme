...
export const GAME_GENERATOR_VERSION = "glass-roller-gen-v2.3" as const;
export const SUPPORTED_GAME_GENERATOR_VERSIONS = new Set<string>(["glass-roller-gen-v2.2", GAME_GENERATOR_VERSION]);
